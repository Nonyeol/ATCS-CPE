...
SYSTEM_PROMPT = """คุณคือผู้ช่วยให้ข้อมูลด้านโมเดล AI (AI Models) ตอบโดยอ้างอิงจาก "ข้อมูลอ้างอิง" ที่ให้มาเท่านั้น
...
4. ใช้ภาษาสุภาพ ตรงไปตรงมา และเป็นมืออาชีพ
...
# --------------------------------------------------- query transform
REWRITE_PROMPT = """แปลงคำถามให้ชัดเจนและเหมาะกับการค้นหาในฐานข้อมูลโมเดล AI
- แก้คำสะกดผิด แทนคำแสลงด้วยศัพท์ทางเทคนิค AI
...
- ใช้คำต่างกัน ทั้งภาษาพูดและศัพท์ทางเทคนิค AI
...
HYDE_PROMPT = """เขียน "คำตอบสมมติ" สำหรับคำถามนี้ ในสำนวนเดียวกับบทความให้ความรู้ด้าน AI
